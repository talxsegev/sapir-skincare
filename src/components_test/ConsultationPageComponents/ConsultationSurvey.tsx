...
const EMAILJS_CONSULTATION_TEMPLATE_ID = import.meta.env.VITE_EMAILJS_CONSULTATION_TEMPLATE_ID;
...
const ConsultationSurvey = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!EMAILJS_SERVICE_ID || !EMAILJS_CONSULTATION_TEMPLATE_ID || !EMAILJS_PUBLIC_KEY) {
      console.error("Missing EmailJS configuration for the consultation form.");
      setStatus("error");
      return;
    }
    ...
    setStatus("sending");
    try {
      await emailjs.sendForm(EMAILJS_SERVICE_ID, EMAILJS_CONSULTATION_TEMPLATE_ID, formRef.current, EMAILJS_PUBLIC_KEY);
      setStatus("success");
    } catch (error) {
